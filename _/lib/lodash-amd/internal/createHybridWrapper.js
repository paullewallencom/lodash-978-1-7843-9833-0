 ...
 */
define(['./composeArgs', './composeArgsRight', './createCtorWrapper', './replaceHolders', './setData'], function(composeArgs, composeArgsRight, createCtorWrapper, replaceHolders, setData) {
