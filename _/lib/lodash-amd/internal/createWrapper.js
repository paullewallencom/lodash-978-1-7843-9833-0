 ...
 */
define(['./baseSetData', './baseSlice', './composeArgs', './composeArgsRight', './createBindWrapper', './createHybridWrapper', './createPartialWrapper', './getData', '../lang/isFunction', './replaceHolders', './setData'], function(baseSetData, baseSlice, composeArgs, composeArgsRight, createBindWrapper, createHybridWrapper, createPartialWrapper, getData, isFunction, replaceHolders, setData) {
